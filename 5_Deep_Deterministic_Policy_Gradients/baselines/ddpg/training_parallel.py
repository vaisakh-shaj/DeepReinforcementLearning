...
def make_env(seed):
    def _f():
        env=ProstheticsEnv(visualize=False,integrator_accuracy = 1e-3)
...
def train(env, nb_epochs, nb_epoch_cycles, render_eval, reward_scale, render, param_noise, actor, critic,
    ...
    with U.make_session() as sess:
        ...
        agent.reset()
        if restore:
            filename="/home/vaisakhs_shaj/Desktop/MODEL/MODEL-2D-NORMAL-REWARD/tfSteps"+str(120000)+".model"
        ...
        for epoch in range(nb_epochs):
            ...
            combined_stats['rollout/return'] = np.mean(episode_rewards_history)
